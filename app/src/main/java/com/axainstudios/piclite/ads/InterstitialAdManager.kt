package com.axainstudios.piclite.ads
...
object InterstitialAdManager {
    ...
    fun preload(context: Context) {
        if (com.axainstudios.piclite.billing.ProManager.isPro) return
    ...
    fun showThenContinue(activity: Activity, onDone: () -> Unit) {
        if (com.axainstudios.piclite.billing.ProManager.isPro) { onDone(); return }
